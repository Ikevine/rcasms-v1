...
<div class="container2">
    ...
    <div class="dright">
        ...
        <form class="cinput" action="createaddress.php?page=createaddress" method="post">
            ...
            <div class="indesc">
                ...
                <input type="text" class="input" placeholder="Enter city name" name="city">
            </div>
            <div class="indesc">
                <input type="text" class="input" placeholder="Enter street Address" name="street">
                <input type="password" class="input" placeholder="Enter pastal Code" name="postal">
            </div>
